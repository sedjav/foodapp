      ...
      admin: {
        ...
        events: {
          ...
          detail: {
            ...
            breakdownFood: "Food",
            breakdownSharedCosts: "Shared costs",
            breakdownHost: "Host participants",
      ...
      admin: {
        ...
        events: {
          ...
          detail: {
            ...
            breakdownFood: "غذا",
            breakdownSharedCosts: "هزینه‌های مشترک",
            breakdownHost: "شرکت‌کننده‌های میزبان",
